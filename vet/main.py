...
class MyWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    "ID", "RFID", "Имя", "Возраст", "Пол", "Вес", "Разница", "Температура", "Рекомендации" ,"Фото", "Добавить рекомендацию",
    ...
    # Кнопка "Показать" в колонке 6
            ...
            self.ui.tableWidget.setCellWidget(row_idx, 10, btn1)
    # Данные кормления
    ...
    def thread(self):
        ...
        self.ai += f"ВетАссистент: Если говорить обобщённо, средний вес взрослой коровы (не телки) обычно находится в диапазоне от 400 до 600 кг. Однако это очень усреднённые данные."
        self.ai += "\n\n"
